...
│   ├── Lending/  Policy + Products + Analytics
│   ├── Risk/     Risk Committee outputs
│   ├── Finance/  P&L + Biz-Plan-2026
...
4. Nếu cần precedent → scan `Wiki/decisions/` (chưa setup)
5. Nếu wiki entry thiếu hoặc cũ → name gap, không fabricate
...
4. **Projects/** chứa deliverable hoàn thiện theo project.
5. **Raw/** là kho source thô, AI đọc nhưng không tự sửa.
6. **_archive/** giữ file cũ — không xoá, để tham chiếu lịch sử.
