...
| [`way-of-working.md`](way-of-working.md) | **Core SOP** — decision protocol, modes, behavioral rules, voice, anti-patterns |
...
8. **If need precedent:** (chưa setup `decisions/`)
...
- [ ] Stakeholders: phone numbers + cách contact preferred (Slack/Zalo/email)?
...
- [ ] Decisions: có muốn setup `Wiki/decisions/` folder (theo template Personal)?
